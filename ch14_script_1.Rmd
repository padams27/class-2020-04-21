...
logistic_fit <-  
    fit(logistic_mod,
        factor(trump) ~ gender + age + educ + race + income + party + ideology, data = cces)
...
predict(logistic_fit, new_data = tibble(gender = "Male", age = 37, educ = 5, race = "Asian", 
                              party = 3, ideology = 3, income = 8))
...
cart_fit <- fit(cart_mod,
                    trump ~ ideology + income + gender + race + age + educ + party,
                    data = cces)
